...
function getRouteForMap() {
    if (hasMap()) {
        ...
        var url = 'GetRouteForMap' + routeSelect.options[routeSelect.selectedIndex].value;
...
function deleteRoute() {
    if (hasMap()) {
        ...
        if (answer){
            ...
            var url = 'Deleteroute' + routeSelect.options[routeSelect.selectedIndex].value;
...
function showMessage(message) {
     messages.innerHTML = 'GPSServer: <strong>' + message + '</strong>';
}
