...
namespace GPSServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                var user = await UserManager.FindAsync(model.PhoneNumber, model.Password);
                if (user != null)
                {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.PhoneNumber, PhoneNumber= model.PhoneNumber, Email = model.Email };
